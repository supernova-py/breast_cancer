...
st.markdown("Take a look at the non-visualized data. It's a maze of confusion for most of us. But wait, there's a game-changer on the left side!(Data Insights tab)")
